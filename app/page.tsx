              ...
              <div className="bg-transparent backdrop-blur-lg p-10 rounded-3xl shadow-2xl max-w-xl mx-auto relative z-10">
                <div className="text-center space-y-6">
                  ...
                  <div>
                    <Link
                      href="/about"
                      className="inline-flex items-center mt-6 px-6 py-3 bg-white text-gray-800 font-semibold rounded-full shadow-lg hover:bg-gray-100 transition-all duration-300"
                    >
                      About Me
                      {/* Arrow Icon */}
                      <svg
